    ...
    <div class="adds">
      ...
      <div class="list">
        <template
          ...
          <div
            draggable="true"
            @dragstart="dragStartCanvasComponent(item)"
            @dragend="dragEndCanvasComponent"
        ...
        <div
          ...
          <div class="list">
            <template
              ...
              <EditConfigItem
                :globalProps="selectedCanvasComponent.domProps"
                :title="item[0]"
        ...
        <div
          ...
          <div class="list">
            <template
              ...
              :key="selectedCanvasComponent.domProps!.id!.default + item[0]">
              <EditConfigItem
                :globalProps="selectedCanvasComponent.styleProps"
                :title="item[0]"
                :value="item[1] as ComponentPropItem">
              </EditConfigItem>
            </template>
...
/**正在被拖拽的元素**/
let draggingComponent: Component | undefined = undefined;

function dragStartCanvasComponent(component: Component): void {
  draggingComponent = component;
}

function dragEndCanvasComponent(): void {
  draggingComponent = undefined;
}

function ondrop(e: DragEvent): void {
  e.preventDefault();
  if (!isNil(draggingComponent)) {
    addCanvasComponent(draggingComponent);
    draggingComponent = undefined;
  }
}
</script>
