...
export type Value =
  | ComponentPropItemConfigOptionObj
  | ComponentPropItemConfigOptionObj[]
  | string
  | number
  | boolean
...
/** 具体属性项值 的 配置选型 类型 */
export type ComponentPropItemConfigOption = string | number | ComponentPropItemConfigOptionObj;
...
export interface ComponentPropItem {
   ...
   * @param {Value} [params.newVal] - 新值
   * @param {Value} [params.oldVal] - 旧值
