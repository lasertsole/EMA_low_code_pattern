...
export const textDomProps: ComponentProps = {
  ...
  readonly: { default: false, config: { type: CONSTRUCT_TO_CONF_COMPONENT_NAME_ENUM.TEXT } },
  placeholder: { default: '请输入内容', config: { type: CONSTRUCT_TO_CONF_COMPONENT_NAME_ENUM.TEXT } }
};
