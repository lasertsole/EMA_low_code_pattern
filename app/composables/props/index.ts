...
// 组件名字映射
export const componentNameToInfoMap:Map<string, Partial<Component>> = new Map([
    ["text",{
        showName:"文本",
...
Object.entries(componentCanvasFiles).map(([path, component])=>{
    ...
    const info: Partial<Component> | undefined =  componentNameToInfoMap.get(componentName)
...
export function addCanvasComponent(component: Component):void {
    let info: Partial<Component> | undefined =  componentNameToInfoMap.get(component.componentName)
